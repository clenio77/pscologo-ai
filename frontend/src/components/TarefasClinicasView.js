...
const TarefasClinicasView = ({
  ...
  const handleAdicionarTarefa = async (e) => {
    ...
    if (
      ...
      !pacienteSelecionado ||
      !novoTituloTarefa.trim() ||
      !novaDescricaoTarefa.trim()
    )
      return;
        ...
        <div style={{ flex: 1, overflowY: 'auto', maxHeight: '480px', paddingRight: '5px' }}>
          {carregandoTarefas ? (
            ...
            <div style={{ textAlign: 'center', padding: '4rem 1rem' }}>
              ...
              >
                Use o painel esquerdo para registrar atividades ou lições de casa. O paciente verá as tarefas no painel
                dele e poderá marcá-las como concluídas.
              </p>
            </div>
          ) : (
